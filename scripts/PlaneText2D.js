...
var PlaneText2D = (function (_super) {
    __extends(PlaneText2D, _super);
    function PlaneText2D(text, options) {
        if (text === void 0) { text = ''; }
        if (options === void 0) { options = {}; }
        _super.call(this, text, options);
    }
    PlaneText2D.prototype.raycast = function () {
        this.mesh.raycast.apply(this.mesh, arguments);
    };
    PlaneText2D.prototype.updateText = function () {
...
exports.PlaneText2D = PlaneText2D;
