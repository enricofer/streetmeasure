...
function old_transform2d(elt, x1, y1, x2, y2, x3, y3, x4, y4) {
...
function transform2d(canvas,ta) {
  var t = general2DProjection(
      ta[0][0][0],ta[0][0][1],
      ta[0][1][0],ta[0][1][1],
      ta[1][0][0],ta[1][0][1],
  ...
  t = [t[0], t[3], 0, t[6],
       t[1], t[4], 0, t[7],
       0   , 0   , 1, 0   ,
       t[2], t[5], 0, t[8]]; //t[2], t[5], 0, t[8]];
  t = "matrix3d(" + t.join(", ") + ")";
  canvas.style["-webkit-transform"] = t;
  canvas.style["-moz-transform"] = t;
  canvas.style["-o-transform"] = t;
